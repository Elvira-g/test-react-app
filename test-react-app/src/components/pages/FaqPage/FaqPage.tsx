                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-8 col-12">
                            { faqGeneral ? 
                                ...
                                <>
                                <h2>General Info.</h2>
                                {faqGeneral.map(item => <AccordionItem key={item.id} id={item.id} title={item.title} text={item.text} />)}
                                </>
                                : null
                            }
                            ...
                            { faqProducts? 
                                ...
                                {faqProducts.map(item => <AccordionItem key={item.id} id={item.id} title={item.title} text={item.text} />)}
                                </>
                                : null
                            }
